 ...
 *
 * <p>Exposes outcomes from the Kafka Streams processing topology.
 *
 * <p>Tutorial Tip: This controller demonstrates <b>Interactive Queries</b>. Instead of querying a
 * traditional database, it queries a <b>State Store</b> that resides directly within the Kafka
 * Streams application memory/disk. This provides ultra-low latency access to real-time aggregates.
 */
@Slf4j
@RestController
