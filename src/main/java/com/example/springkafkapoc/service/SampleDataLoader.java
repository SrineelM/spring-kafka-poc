 ...
 *
 * <p>
 * <b>TUTORIAL:</b> This component "jumpstarts" the system for local
 * development.
 * Instead of manually calling the API, this class runs automatically (if the
 * "local" profile is active)
 * and feeds initial transactions into Kafka.
 *
 * <p>
 * <b>Key Architecture Tip:</b>
 * Notice the {@link Profile} annotation. This ensures the seeder <b>NEVER</b>
 * runs in production.
 * You don't want your real production system getting flooded with morning
 * coffee records!
 */
@Slf4j
@Component
...
public class SampleDataLoader implements CommandLineRunner {
    ...
    private void seedTransaction(String transactionId, String account, BigDecimal amount, String detail) {
