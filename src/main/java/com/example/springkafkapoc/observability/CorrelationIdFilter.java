 ...
 *
 * <p>
 * The first point of entry for tracking a request.
 *
 * <p>
 * Tutorial Tip: In a microservices architecture, you need a way to trace a
 * single business transaction across multiple services. We do this by
 * attaching a <b>Correlation ID</b> to every log statement.
 *
 * <p>
 * <b>WHY @Order(Ordered.HIGHEST_PRECEDENCE):</b>
 * This ensures the ID is generated before any other logic or filters run.
 * If a database or security error occurs early, we already have an ID for it.
 */
@Slf4j
@Component
