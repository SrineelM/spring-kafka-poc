...
public final class TopicConstants {
  ...
  /**
   * All transactions (high-value + normal) merged into a single audit stream.
   *
   * <p>Written by {@link com.example.springkafkapoc.streams.topology.RoutingTopology} so compliance
   * systems have a complete, partition-ordered audit trail without subscribing to multiple topics.
   */
  public static final String ALL_TRANSACTIONS_AUDIT = "all-transactions-audit-topic";

  /**
   * Threshold breach events — emitted when a transaction amount exceeds a configurable limit.
   *
   * <p>Downstream consumers (e.g., alerts, fraud rules engines) subscribe here for real-time
   * notification without polling the main pipeline topics.
   */
