 ...
 *
 * <p>
 * Initializes the Streams engine for real-time aggregation and joining.
 *
 * <p>
 * Tutorial Tip: This class is only active because of
 * {@link EnableKafkaStreams}.
 * We use <b>EXACTLY_ONCE_V2</b> processing to guarantee that financial totals
 * are never double-counted, even if a broker or node crashes.
 */
@Slf4j
@Configuration
@EnableKafkaStreams
