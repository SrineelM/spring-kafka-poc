...
import com.example.springkafkapoc.streams.StreamsDeserializationErrorHandler;
import com.example.springkafkapoc.streams.topology.BalanceTopology;
import com.example.springkafkapoc.streams.topology.FraudTopology;
import com.example.springkafkapoc.streams.topology.MetricsTopology;
import com.example.springkafkapoc.streams.topology.RoutingTopology;
import com.example.springkafkapoc.streams.topology.SessionTopology;
import com.example.springkafkapoc.streams.topology.SourceTopology;
 ...
 *   <li><b>Poison-Pill Resilience:</b> The {@link StreamsDeserializationErrorHandler} is registered
 *       here to prevent corrupt records from crashing stream threads.
 * </ul>
 *
...
public class KafkaStreamsConfig {
   ...
   *
   * <p>The {@link SourceTopology.SourceContext} returned here contains both the keyed and grouped
   * streams, allowing downstream topologies to share them without re-reading from Kafka (which
   * would be wasteful).
   */
  @Bean
  public SourceTopology.SourceContext sourceContext(StreamsBuilder builder) {
  ...
  public KStream<String, TransactionEvent> analyticsTopology(
      StreamsBuilder builder, SourceTopology.SourceContext context) {
